...
class matplotlib_vision(object):
    ...
    def plot_fields_tri(self, out_true, out_pred, coord, cell, cmin_max=None, fmin_max=None, cmap='jet',
                        field_name=None):
    ...
    def plot_fields_am(self, out_true, out_pred, coord, p_id, fig, cmin_max=None):
        ...
        def anim_update(t_id):
            ...
            axes = self.plot_fields_ms(out_true[t_id], out_pred[t_id], coord[t_id], cmin_max=cmin_max,
                                       fmin_max=(fmin, fmax))
            return axes
